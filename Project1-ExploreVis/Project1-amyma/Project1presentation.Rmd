...
- Using median instead of average wage, because of large standard deviations
...
## Pay Difference by Location | Using the Number of Applications
...
nebar<-gvisBarChart(state_ds[c(1:5),1:2], "WORK_STATE", "Count",                 
                    options=list( width=300, height=250,
                    legend="none"))
state_nm<-gvisMerge(negeo,nebar, horizontal=TRUE,tableOptions="cellspacing=5")
```

```{r nj_state_plot, echo= FALSE,results='asis',fig.width=6, fig.height=4,out.extra='style="float:left"'}

plot(state_nm,"chart")
```


## Pay Difference by Location | Using Median Wage
...
sbar<-gvisBarChart(state_ds[c(1:5),], "WORK_STATE","Med_Sa",              options=list(width=300, height=250,legend='none'))

state_ms1<-gvisMerge(sgeo,sbar, horizontal=TRUE,tableOptions="cellspacing=5")
```

```{r rs_state_plot, echo= FALSE,results='asis',fig.width=6, fig.height=4,out.extra='style="float:left"'}
...
[Regional Price Parities(2013)](http://www.bea.gov/newsreleases/regional/rpp/rpp_newsrelease.htm)

Adujusted Median Salary = (Median Salary/Price.Parity)*100

<center><img src="images/pp.png"
	height="365px"/></center>

## Pay Difference by Location | Using Adjusted Median Wage
...
adj_sbar<-gvisBarChart(adj_state_ds[c(1:5),c(1,5)], "WORK_STATE","adj.Med_Sa",                  
                       options=list(width=300, height=250,legend='none'))

state_ms<-gvisMerge(adj_sgeo,adj_sbar, horizontal=TRUE,tableOptions="cellspacing=5")
```

```{r as_state_plot, echo= FALSE,results='asis',fig.width=6, fig.height=4,out.extra='style="float:left"'}
...
>- Size = Count, Color= Median Salary, Max Color= Blue
