...
---
This is the data of comsumer complaints about finance institution.
It is downloaded from https://catalog.data.gov/dataset/consumer-complaint-database.
...
Table 1. Consumer complaints data group by Year.
...
abline(regre)
```
The total complaints number is regressed against time.
