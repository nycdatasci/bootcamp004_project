...
```
As expected, lower density population areas exhibit the lowest numbers, although the previous map shows that central areas such as Westminster have the highest density of users. From the resulting map we clearly see that Westminster, Newham and Ealing have the densest internet access, while Richmond upon Thames has the highest actual number of internet users. Since Westminster is the center of London it should have the highest percentage, given that it would have the densest internet infrastructure, but surprisingly it is surrounded by areas with relatively lower use. Combining with the economic data in previous graphs, this implies that Westminster is the highest income borough, while the neighboring areas of Wandsworth and Southwark have higher levels of unemployment and low income households. 
