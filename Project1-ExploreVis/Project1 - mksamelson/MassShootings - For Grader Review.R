...
ggplot(shootings,aes(year,total.victims))+
...
ggplot(shootings,aes(year,fatalities))+
...
#Create a dataframe to look only at Men
...
#Add Column to shootings_m to group non-White and Black Ethnicities
