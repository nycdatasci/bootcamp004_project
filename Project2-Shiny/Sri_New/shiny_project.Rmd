...
# 
# # US Airport Data
flights <- read.csv("~admin/Datasets/flights (1).csv", stringsAsFactors = F)
airports <- read.csv("~admin/Datasets/airports (1).csv", stringsAsFactors = F)
...
major <- read.csv("~admin/Datasets/major.csv", stringsAsFactors = F)
...
airlines.2 <- read.csv("~admin/Datasets/airlines.2.csv", stringsAsFactors = F)
...
## MOTION CHART DATA
pop <- read.csv("~admin/Datasets/pop_tots.csv", stringsAsFactors = F)
passenger <- read.csv("~admin/Datasets/passenger_tots.csv", stringsAsFactors = F)
gdp <- read.csv("~admin/Datasets/gdp_totals.csv", stringsAsFactors = F)
