...
coswithst1=pd.read_csv("../input/distance_pd_st.csv", encoding="ISO-8859-1",header=None)
coswithst1.columns = ['distance_pd_st']
...
coswithst2=pd.read_csv("../input/distance_pt_st.csv", encoding="ISO-8859-1",header=None)
coswithst2.columns = ['distance_pt_st']
