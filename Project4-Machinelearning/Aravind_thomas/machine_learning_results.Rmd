...
We ran a basic model with the default parameters , out validation results were poor and we decided to follow these steps
...
<img src="images/randomforestchangingvariables.png" height="1200px" width="800px" />
<img src="images/randomforestfeatureaccuracy2.jpeg" height="1200px" width="800px" />
![](images/randomforestfeatureengineering tune.png)
![](images/rf_featureengineering20importance.jpeg)
![](images/rf.tuned17bestmodelimportance.jpeg)
![](images/Tuning randmo cuts and node size Extra trees.jpeg)

#### Boosting Using XGBoost
![](images/xgboost_cv_final_graph.jpeg)
